 ...
 */
@BTrace
public class ClassFileApiEntryTest {
  @OnMethod(clazz = "java.lang.Math", method = "abs")
  public static void onEntry(@ProbeMethodName String pmn) {
    println("Math.abs entered: " + pmn);
  }
}
