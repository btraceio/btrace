 ...
 */
class FlashLightClient extends Client {
    
    private volatile PrintWriter out;

    FlashLightClient(Instrumentation inst, byte[] code, PrintWriter traceWriter) throws IOException {
        super(inst);
        this.out = traceWriter;
        Command cmd = new InstrumentCommand(code, null);
