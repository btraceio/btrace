...
/**
 * This expander takes care of macros related to all the sampling and timing
 * functionality
 *
...
public class MethodTrackingExpander extends BaseTemplateExpander {
    ...
    /**
     * Will provide necessary calls to enable sampling and timing the method or
     * method call.
     * <p>
     ...
     * <li>{@code $MEAN=<mean>} - only when sampling; the mean number of hits
     * between samples</li>
     * <li>{@code $METHODID=<id>} - id generated by
     * {@linkplain MethodID#getMethodId(java.lang.String, java.lang.String, java.lang.String)}
     * </li>
    ...
    /**
     * Will generate the branching logic (if sampling) and/or retrieve the
    ...
    /**
     * Will create the jump target for the else part of the condition generated
     * by {@link MethodTrackingExpander#TEST_SAMPLE} template.
     */
