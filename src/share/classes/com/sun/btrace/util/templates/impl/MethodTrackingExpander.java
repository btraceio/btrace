...
public class MethodTrackingExpander extends BaseTemplateExpander {
     ...
     * <li>{@code $SAMPLER=[Avg | Adaptive]} - selects a sampler, if any</li>
     ...
     * </ul>
     */
    public static final Template TEST = new Template("mc$test", "()V");
    /**
     * Will create the jump target for the else part of the condition
     * generated by {@linkplain MethodTrackingExpander#TEST} template.
     */
    public static final Template ELSE = new Template("mc$else", "()V");
    /**
    ...
    public MethodTrackingExpander(int methodId) {
        super(ENTRY, DURATION, TEST, ELSE, EXIT, RESET);
