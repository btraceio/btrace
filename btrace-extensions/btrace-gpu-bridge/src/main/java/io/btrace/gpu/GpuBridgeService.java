 ...
 *
 * <p>Traces Java-to-GPU boundaries: ONNX Runtime inference sessions, DJL (Deep Java Library)
 * predictions, TensorFlow Java operations, and Panama FFM native calls to CUDA/ROCm libraries. Zero
 * external dependencies — instruments existing client classes.
 *
...
public interface GpuBridgeService {
   ...
   */
  @Nullable InferenceRecord inference(String runtime, String modelName);
  ...
  @Nullable String getModelSummary(String modelName);
