...
public final class IntCountsHistogramFactory {
    ...
    public static IntCountsHistogram newInstance(long highestTrackableValue, int numberOfSignificantValueDigits) {
        return new IntCountsHistogram(highestTrackableValue, numberOfSignificantValueDigits);
    }

    public static IntCountsHistogram newInstance(long lowestDiscernibleValue, long highestTrackableValue, int numberOfSignificantValueDigits) {
        return new IntCountsHistogram(lowestDiscernibleValue, highestTrackableValue, numberOfSignificantValueDigits);
    }
