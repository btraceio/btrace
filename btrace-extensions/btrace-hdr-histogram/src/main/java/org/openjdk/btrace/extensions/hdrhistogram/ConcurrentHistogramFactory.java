...
public final class ConcurrentHistogramFactory {
    ...
    public static ConcurrentHistogram newInstance(long highestTrackableValue, int numberOfSignificantValueDigits) {
        return new ConcurrentHistogram(highestTrackableValue, numberOfSignificantValueDigits);
    }

    public static ConcurrentHistogram newInstance(long lowestDiscernibleValue, long highestTrackableValue, int numberOfSignificantValueDigits) {
        return new ConcurrentHistogram(lowestDiscernibleValue, highestTrackableValue, numberOfSignificantValueDigits);
    }
