...
public class InstrumentorTest extends InstrumentorTestBase {
  ...
  public void methodEntryAllLines() throws Exception {
    ...
    checkTransformation(
        "LDC \"<init>\"\n"
            + "LDC 39\n"
            + "INVOKESTATIC resources/OnMethodTest.$btrace$org$openjdk$btrace$runtime$aux$AllLines$args (Ljava/lang/Object;Ljava/lang/String;I)V\n"
            + "ALOAD 0\n"
            + "LDC \"<init>\"\n"
            + "LDC 40\n"
            + "INVOKESTATIC resources/OnMethodTest.$btrace$org$openjdk$btrace$runtime$aux$AllLines$args (Ljava/lang/Object;Ljava/lang/String;I)V\n"
  ...
  //                + "ALOAD 6\nLLOAD 4\n"
  //                + "INVOKESTATIC
  // resources/OnMethodTest.$btrace$org$openjdk$btrace$runtime$aux$MethodCallDuration$args
