...
public class TemplateExpanderVisitor extends BTraceMethodVisitor {
  ...
  public AnnotationVisitor visitLocalVariableAnnotation(
      int i, TypePath tp, Label[] labels, Label[] labels1, int[] ints, String string, boolean bln) {
    if (expandTemplate(null) == TemplateExpander.Result.IGNORED) {
  ...
  public void visitLocalVariable(
      String string, String string1, String string2, Label label, Label label1, int i) {
    if (expandTemplate(null) == TemplateExpander.Result.IGNORED) {
