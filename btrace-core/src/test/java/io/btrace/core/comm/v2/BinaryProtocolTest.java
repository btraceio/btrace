...
public class BinaryProtocolTest {
  ...
  public void testCommandAdapter() throws IOException {
    ...
    io.btrace.core.comm.Command originalCmd = CommandAdapter.toBtraceCommand(exitCmd);
    assertEquals(io.btrace.core.comm.Command.EXIT, originalCmd.getType());
  ...
  public void testBinaryNumberMapDataCommand() throws IOException {
    ...
    assertEquals(new BigInteger("123456789012345678901234567890"), readData.get("bigIntValue"));
  ...
  public void testBinaryRetransformationStartNotification() throws IOException {
    ...
    // Create and write command
    BinaryRetransformationStartNotification original =
        new BinaryRetransformationStartNotification(150);
    BinaryWireIO.write(baos, original);
    ...
    BinaryRetransformationStartNotification notification =
        (BinaryRetransformationStartNotification) readCommand;
  ...
  public void testBinaryRetransformClassNotification() throws IOException {
    ...
    // Create and write command
    BinaryRetransformClassNotification original =
        new BinaryRetransformClassNotification("com.example.MyClass", 10, 150);
    BinaryWireIO.write(baos, original);
    ...
    BinaryRetransformClassNotification notification =
        (BinaryRetransformClassNotification) readCommand;
