...
class AverageTest {
  ...
  void testLargeValues() {
    ...
    assertEquals(largeValue, average.getValue(), "Average should preserve full 64-bit precision");
  }
  ...
  void testLargeSum() {
    ...
    assertEquals(expected, average.getValue(), "Average of large values should not truncate");
  }
  ...
  void testMixedValues() {
    ...
    assertEquals(
        expected, average.getValue(), "Average should not lose precision with very large sums");
  }
