...
/** Exception thrown when the protocol version in the stream doesn't match the expected version. */
public class ProtocolVersionMismatchException extends IOException {
  ...
  public ProtocolVersionMismatchException(int expectedVersion, int actualVersion) {
    super(
        String.format(
            "Protocol version mismatch: expected %d, got %d", expectedVersion, actualVersion));
